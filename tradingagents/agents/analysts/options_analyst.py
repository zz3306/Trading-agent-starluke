...
def create_options_analyst(llm):
    ...
    def options_analyst_node(state):
        ...
        system_prompt = (
            ...
            f"Workflow:\n"
            f"Use your available tools to fetch the current stock price, historical volatility, "
            f"and options chain for {ticker}.\n\n"
            f"Write a structured Options Analysis Report with:\n\n"

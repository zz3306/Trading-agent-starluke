...
def create_valuation_analyst(llm):
    ...
    def valuation_analyst_node(state):
        ...
        system_prompt = (
            ...
            f"Step 1 — Identify 3-4 direct competitor ticker symbols for {ticker} from your knowledge.\n"
            f"Step 2 — Call tools to fetch fundamentals and income statement for each peer company.\n"
